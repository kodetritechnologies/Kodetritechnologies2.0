      ...
      <div className="container">
        <div className="banner-why-choose">
          ...
          <div className="bn-content">
            ...
            <div className="" id="accordion-v2">
              <div className="accordion-item_v2">
                <div
                  className="accordion-action lh-24 fw-medium"
                ...
                >
                  <p className="faq-content cl-text-2">
                    ...
                    fashion-forward clothing accessories. We pride ourselves on
                    offering a curated selection of rare beautiful items sourced
                    both locally and globally. Our mission is to bring you the
                    latest trends & timeless styles, ensuring every piece
              ...
              <div className="accordion-item_v2">
                <div
                  className="accordion-action collapsed lh-24 fw-medium"
