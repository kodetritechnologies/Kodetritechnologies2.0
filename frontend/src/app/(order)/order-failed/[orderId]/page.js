          ...
          <div className="col-lg-8 col-xl-7">
            ...
            <div className="card border-0 shadow-sm rounded-4 p-4 p-md-5 bg-white mb-4">
              ...
              <div className="mb-5 text-center">
                <div className="mb-3">
                  <i className="fa-regular fa-circle-xmark text-danger" style={{ fontSize: "3.5rem" }}></i>
                </div>
                ...
                <p className="text-secondary mb-0 mx-auto small" style={{ maxWidth: "450px" }}>
                  Unfortunately, your payment for Order #{order.order_no} could not be processed successfully.
                </p>
              </div>
            ...
            <div className="d-flex flex-wrap justify-content-center gap-3 mb-5">
              <Link href="/checkout" className="tf-btn animate-btn text-white w-auto px-5" style={{ backgroundColor: "#dc3545", borderColor: "#dc3545" }}>
                Try Again
              </Link>
