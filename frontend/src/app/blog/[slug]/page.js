              ...
              <div className="col-lg-12">
                <div className="blog-image">
                  <img
                    ...
                    width="1410"
                    height="600"
                    src="/assets/images/blog/detail-1.jpg"
                    alt="Image"
                  />
                </div>
              </div>
                ...
                <div className="blog-content">
                  ...
                  <div className="box-social-tag">
                    <div className="tags-right  d-flex align-items-center flex-wrap gap-8">
                      <p>Tags:</p>
                      <a href="blog.html" className="tag-item text-caption-01">
                        fashion
                      </a>
                      <a href="blog.html" className="tag-item text-caption-01">
                        style
                  ...
                  <div className="group-direc">
                    <a href="blog-single.html" className="btn-direc prev link">
                    ...
                    <a href="blog-single.html" className="btn-direc next link">
                      <p className="fw-semibold text-decoration-underline">
                        Next
                      </p>
                      <p className="name-post h6 fw-medium">
                        Why Accessories Define More Than Outfit
                      </p>
                    </a>
                  </div>
                </div>
