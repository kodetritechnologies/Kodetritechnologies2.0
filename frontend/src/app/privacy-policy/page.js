        ...
        <div className="container">
          <div className="content">
            <div className="term-item">
              <h5 className="term-title">1. Information We Collect</h5>
              <div className="text-wrap">
                ...
                <p className="term-text cl-text-2">
                  ...
                  including your name, billing address, shipping address, and
                  payment information (including credit card number, email
            ...
            <div className="term-item">
              <h5 className="term-title">2. How We Use Your Information</h5>
              <div className="text-wrap">
                <p className="term-text cl-text-2">
            ...
            <div className="term-item">
              ...
              <div className="text-wrap">
                <p className="term-text cl-text-2">
                  ...
                  example, we use Shopify to power our online store--you can
                  read more about how Shopify uses your Personal Information
                  here: https://www.shopify.com/legal/privacy. We also use
                  Google Analytics to help us understand how our customers use
                  the Site--you can read more about how Google uses your
            ...
            <div className="term-item">
              <h5 className="term-title">4. Data Retention</h5>
              <p className="term-text cl-text-2">
            ...
            <div className="term-item">
              <h5 className="term-title">5. Your Rights</h5>
              <p className="term-text cl-text-2">
            ...
            <div className="term-item">
              <h5 className="term-title">6. Changes</h5>
              <p className="term-text cl-text-2">
            ...
            <div className="term-item">
              <h5 className="term-title">7. Contact Us</h5>
              <div className="text-wrap">
                <p className="term-text cl-text-2">
                  For more information about our privacy practices, if you have
                  questions, or if you would like to make a complaint, please
                  contact us by e-mail at [Email Address] or by mail using the
                  details provided below:
                </p>
                <a href="mailto:contact@amerce.com" className="link fw-medium">
                  contact@amerce.com
                </a>
              </div>
            </div>
